...
let paths = {
    ...
    libs: {
        src: [
            ...
            'node_modules/bootstrap/js/dist/scrollspy.min.js',
...
exports.default = parallel(pugs, styles, libs, scripts, images, sprites, browsersync, startwatch);